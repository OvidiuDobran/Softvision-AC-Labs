...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { default: @currency.default, name: @currency.name, symbol: @currency.symbol } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { default: @currency.default, name: @currency.name, symbol: @currency.symbol } }
